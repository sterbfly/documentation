...
|---|---|---|
| [`en.json`](https://github.com/tootsuite/mastodon/blob/master/app/javascript/mastodon/locales/en.json) | `app/assets/javascripts/components/locales/en.jsx` | Strings for the web client |
